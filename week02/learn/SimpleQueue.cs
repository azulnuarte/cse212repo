public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Dequeue was trying to access index 1 instead of index 0.
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue was inserting the value at index 0 instead of at the end of the queue.
